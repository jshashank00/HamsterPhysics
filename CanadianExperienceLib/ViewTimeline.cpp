            ...
            wxBORDER_SIMPLE)
{
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewTimeline::OnEditMachineProperties, this, XRCID("SetMachine1"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewTimeline::OnEditMachine2Properties, this, XRCID("SetMachine2"));
...
void ViewTimeline::OnEditMachineProperties(wxCommandEvent& event){

    MachineDlg dlg(this->GetParent(), GetPicture()->GetMachine1());
    if (dlg.ShowModal() == wxID_OK)
    {
...
void ViewTimeline::OnEditMachine2Properties(wxCommandEvent& event){

    MachineDlg dlg(this->GetParent(), GetPicture()->GetMachine2());
    if (dlg.ShowModal() == wxID_OK)
    {
        // A machine has been selected
        //mMachineSystem->SetMachineNumber(num);
