...
private:
    ...
    /**
   * Handles the event triggered for editing Machine 1.
   * @param event The wxCommandEvent associated with the edit action.
   */
    void OnEditMachine1(wxCommandEvent &event);

    /**
     * Handles the event triggered for editing Machine 2.
     * @param event The wxCommandEvent associated with the edit action.
     */
    void OnEditMachine2(wxCommandEvent &event);

/**
 * Handles the event triggered for setting the timeline.
 * @param event The wxCommandEvent associated with setting the timeline.
 */
    void OnEditSetTimeline(wxCommandEvent &event);
