...
ViewEdit::ViewEdit(wxFrame* parent) :wxScrolledCanvas(parent, wxID_ANY)
{
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachine1, this, XRCID("Machine1"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachine2, this, XRCID("Machine2"));
...
void ViewEdit::OnEditMachine1(wxCommandEvent &event)
{

    GetPicture()->SelectMachine(this->GetParent(), 1);
    //Refresh();
}
void ViewEdit::OnEditMachine2(wxCommandEvent &event)
{
    GetPicture()->SelectMachine2(this->GetParent(), 2);
    //Refresh();
}
void ViewEdit::OnEditSetTimeline(wxCommandEvent &event){
